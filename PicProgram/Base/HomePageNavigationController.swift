...
//        buildNavigationBarItem()
    ...
    func buildNavigationBarItem() {
        ...
        self.navigationBar.tintColor = xsColor_main_black
        self.navigationBar.titleTextAttributes = [NSAttributedStringKey.font:xsFont(18),NSAttributedStringKey.foregroundColor:xsColor_title_select]
